// Version/ProyectoCubo_8.4
// Updates: void Solution()
...
public class FormCubo extends javax.swing.JFrame {
    ...
    void Solucion() {
        ...
        for (int i = 1; i <= reg; i++) {
            ...
            if (Mov[i].equals("A1"))
                B1();
            else if (Mov[i].equals("A2"))
                B2();
            else if (Mov[i].equals("A3"))
                B3();

            // Movimientos de B
            else if (Mov[i].equals("B1"))
                A1();
            else if (Mov[i].equals("B2"))
                A2();
            else if (Mov[i].equals("B3"))
                A3();
        }
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 497,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
